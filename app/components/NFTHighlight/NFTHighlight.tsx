...
const NFTHighlight = () => {
  return (
    <section className="mt-56 max-w-full h-dvh bg-[url(/NFT_highlight.png)] bg-no-repeat bg-center bg-cover ">
      <div className="max-w-full h-full container  bg-gradient-to-b from-transparent to-violet-500">
        <div className="max-w-[72rem] container h-full flex justify-between text-cyan-50 items-end pb-40">
          <div className="flex flex-col gap-8">
            <button className="bg-zinc-600 py-4 rounded-full w-44 hover:bg-zinc-500 duration-300">
              <NFTArtist
                name="Shroomie"
