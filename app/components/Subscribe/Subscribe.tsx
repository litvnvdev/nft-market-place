...
const Subscribe = () => {
  return (
    <section className="my-20 px-8 py-8">
      <div className="container flex flex-col md:flex-row md:gap-12 md:max-w-[72rem] lg:max-w-[80rem] items-center px-8 py-12 bg-neutral-700 rounded-3xl ">
